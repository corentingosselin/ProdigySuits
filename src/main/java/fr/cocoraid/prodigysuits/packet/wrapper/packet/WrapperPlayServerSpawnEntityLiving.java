...
public class WrapperPlayServerSpawnEntityLiving extends AbstractPacket {
	...
	public void setX(double value) {
		handle.getIntegers().write(2, Integer.valueOf((int)Math.floor(value * 32.0D)));
	}
	...
	public void setY(double value) {
		handle.getIntegers().write(3, Integer.valueOf((int)Math.floor(value * 32.0D)));
	}
	...
	public void setZ(double value) {
		handle.getIntegers().write(4, Integer.valueOf((int)Math.floor(value * 32.0D)));
	}
	...
	public void setHeadPitch(float value) {
		handle.getBytes().write(1, Byte.valueOf((byte)(int)(value * 256.0F / 360.0F)));
	}
